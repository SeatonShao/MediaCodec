...
<body class="body" style="overflow-x: hidden;">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="10"><img src="../../images/img_04.gif" width="12"
				height="37" /></td>
			<td background="../../images/img_05.gif">&nbsp;</td>
			<td width="12"><img src="../../images/img_06.gif" width="12"
				height="37" /></td>
		</tr>
		<tr>
						...
						<td colspan="3"><table width="100%" border="0"
								...
								<tr>
									...
									<td><table width="100%" border="0" align="right"
											cellpadding="1" cellspacing="1" bgcolor="7C92B7">
											<tr>
												<td height="49" bgcolor="#FFFFFF"><table width="100%"
														border="0" cellspacing="1" cellpadding="1">
														<tr>
															<td height="29" colspan="2"><table width="100%"
																	border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td height="29" background="../../images/bei.gif">
																			<img src="../../images/v.gif" width="8" height="9" />
																			<span class="style7">提示信息！</span>
																		</td>
																	</tr>
																</table></td>
														</tr>
														<tr>
															<td width="42%" height="87" bgcolor="#FFFFFF"><div
																	align="center">
																	<img src="../../images/2.gif" width="133" height="134" />
																</div></td>
															<td width="58%" bgcolor="#FFFFFF"><font color="red">页面出错啦－－未找到指定页面。<br />错误原因：<br />一、该页面可能不存在。<br />
																	二、网络连接可能没插好。<br />三、网址输入错误等。<br />
																<br /> 请重试或者与管理员联系!
															</font></td>
														</tr>
														<tr>
